...
plt.title(' Accuracy In epoch NN Each ' + str(s_epoch) + ' - ' + str(e_epoch))
plt.savefig(imagedir + 'Accuracy-epoch-' + str(e_epoch))
plt.show()
...
plt.ylabel('value')
plt.xlabel('step in epoch x10')
plt.title('Accuracy And Loss In Of ' + legend[select] )
