...
class MyCNNmodel(object):
    ...
    def __init__(self,):
        ...
        self.savePath      = self.modeldir + 'ModelOne.ckpt'        #模型稳健
        self.parameterPath = self.modeldir + 'ParameterOne.txt'     #参数文件
    ...
    def conv_net(self,x, p_keep_conv, p_keep_hidden):
        ...
        pool1 = self.max_pool3x3(conv1,k = 3)
        ...
        pool2 = self.max_pool3x3(conv2,k = 3)
        ...
        pool3 = self.max_pool3x3(conv3,k = 3)
        # print "pool3 shape = ",pool3.get_shape()
    
        w4 = self.init_weights([128 * 2 * 2, 1200])
    ...
    def predict(self,x_test,y_test):
        ...
        np.save('./npyfile/hypothesis1',hypo)
